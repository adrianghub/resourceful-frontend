...
export default function Form({ currentId, setCurrentId }) {
  const [postData, setPostData] = useState({ title: '', message: '', snippetUrl: '', tags: '', selectedFile: '', isLiked: false });
    ...
    return (
      <Paper className={classes.paper}>
        <Typography variant="h6" align="center">
          Please Sign In first to create your own snippet hint post.
        </Typography>
      </Paper>
    )
  }
  ...
  const clear = () => {
    setCurrentId(null);
    setPostData({ title: '', message: '', snippetUrl: '', tags: '', selectedFile: '', isLiked: false });
  }
